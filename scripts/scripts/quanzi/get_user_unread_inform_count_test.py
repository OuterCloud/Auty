...
def get_user_unread_inform_count_test(accountId):
	s = requests.Session()
	url = 'http://quanzi.caipiao.163.com/getUserUnReadInformCount.html'
	data = {
...
def basic_assert(r):
	...
	tylan_assert_include(jsonResult,'informCount')

if __name__ == '__main__':
    basic_assert(get_user_unread_inform_count_test('runcheck5@163.com'))