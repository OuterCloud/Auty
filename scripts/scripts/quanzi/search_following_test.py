...
def search_following_test(accountId,userNameForSearch):
	s = requests.Session()
	url = 'http://quanzi.caipiao.163.com/circle_searchFollowing.html'
	data = {
...
if __name__ == '__main__':
    basic_assert(search_following_test('runcheck5@163.com','zss'))